...
<!-- Delete when: native Claude Code pull request review and comment tracking integrated into UI -->
...
- When a code quality gate is needed before shipping

## Review Process

### 1. Understand the Change
- What problem does this code solve?
- Reference the related task description or issue
