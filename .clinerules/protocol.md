...
## Handoff Protocol
The sending agent writes the handoff prompt to `.agents/handoff.md`, updates `state.json` → `handoff` field. In Cline, start a new conversation with the target agent's rules active.
