...
- NEVER read commit messages or PR descriptions before auditing
...
## Full Protocol
See `.github/agents/security.agent.md` — complete audit process, dependency review, reporting format.
